...
async function getStartManifest(matchedRoutes) {
  const { tsrStartManifest } = await import("./assets/_tanstack-start-manifest_v-CHoYCvBf.js");
...
async function loadEntries() {
  const [routerEntry, startEntry, pluginAdapters] = await Promise.all([
    import("./assets/router-mV0TyBVv.js"),
...
var ROUTER_BASEPATH = "salesagent-ai";
var SERVER_FN_BASE = "/salesagent-ai/_serverFn/";
